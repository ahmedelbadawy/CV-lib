...
// double cont_energy(int* x_points, int* y_points,int points_n){
//     double cont_sum = 0;
//     double dist = 0;
...
void greedy_contour(img::Image source, int iterations ,int alpha, int beta, int gamma,int* x_points, int* y_points, int points_n, int window_size){
    ...
    int current_x[points_n];
    int current_y[points_n];
...
// double internal_energy(int* x_points, int* y_points,int points_n, double alpha, double beta){
//     double energy = alpha * cont_energy(x_points, y_points, points_n) + beta * curv_energy(x_points, y_points, points_n);
//     return energy
// }
